    ...
    <body class="sb-nav-fixed" style="background-color:green;">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="form-group row">
                    <label for="deskripsi" class="col-4 col-form-label">Deskrpsi</label> 
                    <div class="col-8">
                    <div class="input-group">
                        <div class="input-group-prepend">
                        <div class="input-group-text">
                        ...
                        <input id="deskripsi" name="deskripsi" value="<?=$row['deskripsi']?>"cols="40" rows="5" class="form-control">
                    </div>
                    </div>
                </div>
                ...
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; FadhilahNezaSolikhah 2023</div>
                        <div>
