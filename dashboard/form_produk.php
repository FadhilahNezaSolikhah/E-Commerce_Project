                ...
                <form method="POST" action="proses_produk.php">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="input-group">
                            ...
                            <select id="merk_id" name="merk_id" class="custom-select">
                                <option value="1" >Sinar Dunia</option>
                                <option value="2" >Joyko</option>
                                <option value="3" >Stabilo</option>
                                <option value="4" >Jotter</option>
                            </select>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="input-group">
                            ...
                            <input id="deskripsi" name="deskripsi" value="" type="text" class="form-control" placeholder="Masukkan Deskripsi">
                        </div>
                        </div>
                    </div>
